workflow nmdc_mags {
    ...
    File    sam_file
    File    gff_file
    #String  container_mbin = "microbiomedata/nmdc_mbin:0.1.2"
    String  container_mbin = "microbiomedata/nmdc_mbin@sha256:0a7bfa50719f5b4b173065fc23c28ec6e2eeed1ac794f605903776e06850c141"
    #String container_meta="scanon/nmdc-meta:v0.0.2"
    String container_meta="scanon/nmdc-meta@sha256:3995451bb1fbf7d0c5548b6824aed35bfa175f580b23754d54a4788eafe6f665"
    File?   map_file
    File?   domain_file
    String? scratch_dir
    Int     cpu=32
    ...
    String gtdbtk_database="/refdata/nmdc/GTDBTK_DB"
...
task make_output{
    ...
    command{
            [ -n ${sep="" hqmq_bin_fasta_files} ] && zip hqmq-metabat-bins.zip ${sep=" " hqmq_bin_fasta_files}
            [ -n ${sep="" bin_fasta_files} ] && zip metabat-bins.zip ${sep=" " bin_fasta_files}
            if [ ! -d ${outdir} ] ; then
                mkdir -p ${outdir}
